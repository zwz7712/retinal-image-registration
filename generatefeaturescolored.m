function [trans, image, description, features] = generatefeaturescolored(img, ...
                                                  mask, scales, paderosionsize,showExtend,showPostImage)
...
%
% Copyright (C) 2006  Jo鉶 Vitor Baldini Soares
%
...
%       description = strvcat(description, des);
      description = char(description, des);
      disp(des);
    end
  end
end
image = removeOutImage(trans,mask,showPostImage);